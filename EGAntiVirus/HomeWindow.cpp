...
{
	wxLaunchDefaultBrowser(wxT("https://www.facebook.com/egsoftweb"), wxBROWSER_NOBUSYCURSOR);
}

void AVHomeWindow::OnBunttonTwitter(wxCommandEvent& event)
{
	wxLaunchDefaultBrowser(wxT("https://twitter.com/EGSoftWeb"), wxBROWSER_NOBUSYCURSOR);
}
