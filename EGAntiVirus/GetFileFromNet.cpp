...
{
#ifdef __WIN64__
	wxString urlstr = wxT("http://www.egsoftweb.in/download/EG Anti Virus2017/Update/EGAV2017_WIN7x64_UPDATE.zip");
#else
	wxString urlstr = wxT("http://www.egsoftweb.in/download/EG Anti Virus2017/Update/EGAV2017_WIN7x86_UPDATE.zip");
#endif
	wxURL url(urlstr);
